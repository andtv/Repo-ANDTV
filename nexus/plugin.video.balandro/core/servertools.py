...
def corregir_servidor(servidor):
    ...
    elif servidor in ['sbplay', 'sbplay1', 'sbplay2', 'pelistop', 'sbfast', 'sbfull', 'ssbstream', 'sbthe', 'sbspeed', 'cloudemb', 'tubesb', 'embedsb', 'playersb', 'sbcloud1', 'watchsb', 'viewsb', 'watchmo', 'streamsss', 'sblanh', 'sbanh', 'sblongvu', 'sbchill', 'sbrity', 'sbhight', 'sbbrisk', 'sbface', 'view345', 'sbone', 'sbasian', 'streaamss', 'lvturbo', 'sbnet', 'sbani', 'sbrapid', 'cinestart']: return 'streamsb'

    elif servidor in ['slmaxed', 'sltube', 'slwatch']: return 'streamlare'
    elif servidor in ['streamhide', 'playhide', 'guccihide', 'moviesm4u', 'louishide', 'ahvsh']: return 'streamhide'
    ...
    elif servidor in ['doodstream', 'dood', 'dooood']: return 'doodstream'
    ...
    elif servidor in ['tubeload', 'mvidoo', 'rutube', 'filemoon', 'streamhub', 'uploadever', 'yandex', 'yadi.', 'fastupload', 'dropload', 'streamwish', 'krakenfiles', 'hexupload']: return 'various'
