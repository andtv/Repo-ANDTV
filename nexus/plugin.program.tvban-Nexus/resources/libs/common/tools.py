        ...
        if yes:
            if use:
                ...
                window.show_text_box("Viewing Removed ASCII Files",
                                  "[COLOR gold][B]{0} Archivos Eliminados:[/B][/COLOR]\n {1}\n\n[COLOR gold][B]{2} Archivos Fallidos:[B][/COLOR]\n {3}".format(f1, msg, f2, msg2))
        else:
            window.show_text_box("Viewing Found ASCII Files", "[COLOR gold][B]{0} Archivos Encontrados:[/B][/COLOR]\n {1}".format(f1, msg))
    else:
        logging.log_notify(CONFIG.ADDONTITLE,
