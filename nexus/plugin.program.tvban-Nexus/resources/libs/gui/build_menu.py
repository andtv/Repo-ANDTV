...
class BuildMenu:
    ...
    def get_listing(self):
        ...
        if response:
            ...
            directory.add_file('[B]Version Kodi:[/B] [COLOR azure]{0}[/COLOR]'.format(CONFIG.KODIV), icon=CONFIG.ICONBUILDS,
        ...
        if len(match) >= 1:
            if CONFIG.SEPARATE == 'true':
                ...
                if count20 > 0:
                    ...
                    directory.add_file('[B][COLOR dodgerblue]{0} BUILDS:[/COLOR][/B] [B][COLOR azure] ANDTV[/COLOR] [COLOR blueviolet]NEXUS[/COLOR] [COLOR azure]({1})[/COLOR][/B]'.format(state, count20), {'mode': 'togglesetting',
            ...
            if adultcount > 0:
                directory.add_file('[COLOR azure]Actualmente Solo hay Builds para Adultos[COLOR]', icon=CONFIG.ICONBUILDS,
                                   themeit=CONFIG.THEME3)
                directory.add_file('[COLOR azure]Habilitar Mostrar Adultos en los Ajustes del Addon[COLOR] > Misc', icon=CONFIG.ICONBUILDS,
                                   themeit=CONFIG.THEME3)
            else:
