        ...
        if len(match) >= 1:
            if CONFIG.SEPARATE == 'true':
                ...
                if count20 > 0:
                    ...
                    directory.add_file('[B][COLOR dodgerblue]{0} BUILDS:[/COLOR][/B][COLOR azure][B] ANDTV[/COLOR] [COLOR blueviolet]NEXUS[/B][/COLOR]'.format(state, count19), {'mode': 'togglesetting',
