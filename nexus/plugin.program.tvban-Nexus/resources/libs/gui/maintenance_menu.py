...
class MaintenanceMenu:
    ...
    def clean_menu(self):
        ...
        if xbmc.getCondVisibility('System.HasAddon(script.module.urlresolver)') or xbmc.getCondVisibility(
            ...
            directory.add_file('Borrar Caches de Funciones de Resolución', {'mode': 'clearfunctioncache'}, icon=CONFIG.ICONMAINT,
        ...
        directory.add_file('Borrar Registros de Fallos', {'mode': 'clearcrash'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
        ...
        if autoclean == 'true':
            ...
            directory.add_file(
                '[COLOR azure]---[/COLOR] Frecuencia de Limpieza Automática: [B][COLOR azure]{0}[/COLOR][/B]'.format(cache.replace('true', on).replace('false', off)),
                {'mode': 'togglesetting', 'name': 'clearcache'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
            directory.add_file(
                '[COLOR azure]---[/COLOR] Borrar Cache al Iniciar: {0}'.format(packages.replace('true', on).replace('false', off)),
                {'mode': 'togglesetting', 'name': 'clearpackages'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
            directory.add_file(
                '[COLOR azure]---[/COLOR] Borrar Paquetes al Iniciar: {0}'.format(thumbs.replace('true', on).replace('false', off)),
    ...
    def logging_menu(self):
        ...
        errorsfound = str(errors) + 'Error(es) Encontrado' if errors > 0 else 'None Found'
        ...
        directory.add_file('Alternar Registro de Depuración', {'mode': 'enabledebug'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
    ...
    def tweaks_menu(self):
        ...
        directory.add_file('Escanear en busca de repositorios rotos', {'mode': 'checkrepos'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
